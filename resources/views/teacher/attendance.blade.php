    ...
    <form method="GET">
        <div class="flex flex-col sm:flex-row sm:flex-wrap sm:items-center gap-3">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('teacher.attendance.export', request()->all()) }}" class="btn-indigo flex items-center gap-2">
        ...
        <table class="w-full" style="min-width:540px;">
            ...
            <tbody class="divide-y divide-slate-50">
                ...
                <tr class="hover:bg-slate-50/50 transition-colors">
                    ...
                    <td class="py-3.5"><span class="badge-slate whitespace-nowrap">{{ $record->periodLabel() }}</span></td>
                    <td class="py-3.5">
