...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
    <div class="card p-4">
        <div class="flex items-center justify-between mb-2">
            <p class="text-slate-500 text-[10px] font-bold uppercase tracking-wider">Classes</p>
        ...
        <p class="font-display text-2xl font-bold text-slate-900">{{ $stats['classes'] }}</p>
    </div>

    <div class="card p-4">
        <div class="flex items-center justify-between mb-2">
            <p class="text-slate-500 text-[10px] font-bold uppercase tracking-wider">Students</p>
        ...
        <p class="font-display text-2xl font-bold text-slate-900">{{ $stats['students'] }}</p>
    </div>

    <div class="card p-4">
        <div class="flex items-center justify-between mb-2">
            <p class="text-slate-500 text-[10px] font-bold uppercase tracking-wider">Teachers</p>
            <div class="w-8 h-8 bg-purple-50 rounded-lg flex items-center justify-center">
                <svg class="w-4 h-4 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857"/></svg>
            </div>
        </div>
        <p class="font-display text-2xl font-bold text-slate-900">{{ $stats['teachers'] }}</p>
    </div>

    <div class="card p-4">
        <div class="flex items-center justify-between mb-2">
            <p class="text-slate-500 text-[10px] font-bold uppercase tracking-wider">HODs</p>
            <div class="w-8 h-8 bg-indigo-50 rounded-lg flex items-center justify-center">
                <svg class="w-4 h-4 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>
            </div>
        </div>
        <p class="font-display text-2xl font-bold text-slate-900">{{ $stats['hods'] }}</p>
    </div>

    <div class="card p-4">
        <div class="flex items-center justify-between mb-2">
            <p class="text-slate-500 text-[10px] font-bold uppercase tracking-wider">Today</p>
        ...
        <p class="font-display text-2xl font-bold text-slate-900">{{ $stats['today_attendance'] }}</p>
    </div>
</div>
