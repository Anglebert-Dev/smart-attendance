                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-2 mt-1">
                                <div class="w-8 h-8 bg-{{ $record->methodColor() }}-50 rounded-lg flex items-center justify-center text-{{ $record->methodColor() }}-600">
                                    {!! $record->methodIcon() !!}
                                </div>
                                <span class="text-sm font-medium text-slate-700">{{ $record->methodLabel() }}</span>
                            </div>
                        </div>
                    </div>
